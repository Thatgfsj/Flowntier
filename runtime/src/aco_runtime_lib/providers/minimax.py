...
Reads API key from `MINIMAX_API_KEY` env var (per CLAUDE.md and
docs/SECURITY.md §2). No secrets in code.

See `docs/PROVIDER_SPEC.md` §3 (Provider trait) and §8 (MiniMax).
"""
...
class MiniMaxProvider(Provider):
    """MiniMax M3 (and friends) via the OpenAI-compatible chat endpoint."""
    ...
    def __init__(
        ...
        self.id = "minimax"
        self.capabilities: frozenset[str] = frozenset({"chat", "stream", "json_mode"})
