...
import { INITIAL_STATE, workflowReducer, type RootState } from "./workflowReducer.js";
...
describe("workflowReducer", () => {
  ...
  it("TICK flips a stale non-idle role back to idle", () => {
    ...
    const later = started.agentStatus.chief.since + 16_000;
  ...
  it("RESET clears workflow-only state but keeps workdir and busy", () => {
    const dirty: RootState = {
      ...
      busy: true,
      workdir: "C:/work",
      tasks: [{ id: "t0", title: "x", owner: "", state: "pending" }],
