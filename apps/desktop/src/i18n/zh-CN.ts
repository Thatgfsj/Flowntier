...
const zhCN = {
  ...
  "settings.confirm.removeModel.body": "这个模型会从 {{provider}} 的回退链里移除。确定吗?",
  "settings.confirm.deleteCustom.title": "删除中转站 {{name}}?",
  "settings.confirm.deleteCustom.body": "该中转站和它的 API key 会被删除。确定吗?",
  ...
  "settings.confirm.deleteKey.body": "该 keychain 条目会被删除，供应商行保留。可以重新填入新 key。",
  ...
  "settings.custom.keyNotEnv": "只存到 keychain，不读取同名的系统环境变量。",
  ...
  "settings.models.emptyFallback": "（暂无回退；主模型失败时该角色会直接报错）",
  ...
  "settings.models.emptyCustomModels":
    "暂无自选模型。点击「拉取最新模型」从 {{provider}} 官方 API 拉取可用列表，勾选要加入的即可。",
  ...
  "settings.about.clearDataConfirmBody":
    "此操作会删除 %APPDATA%\flowntier\ 下的所有文件：API 密钥、自定义供应商、运行日志、错误日志。无法撤销。",
  ...
  "welcome.step2.subtitle":
    "下面是一个真实的工作流示例，会走完 首席 → 规划 → 工匠 → 审查 → 汇报 五个角色。",
  ...
  "settings.about.searchBugHint":
    "粘贴 ErrorBoundary 上的错误码 (例如 FE-3a7b9c2d)，会在本地日志中查找匹配行。",
  ...
  "workdir.subtitleFirst":
    "在 AI 开始工作前，请选一个本地目录作为项目根目录。每个新项目会作为子目录自动创建。",
  ...
  "chatZone.subtitle": "由设置 → 角色 → 模型 分配驱动",
  "chatZone.clear": "清空",
  "chatZone.role": "角色",
  "chatZone.resolve.ok": "默认",
  "chatZone.resolve.unconfigured": "未配置: 在设置 → 角色 → 模型 分配里选个默认模型",
  "chatZone.resolve.noKey": "未配置 API 密钥: 在设置 → 供应商里粘贴 key",
  "chatZone.ready": "准备就绪",
  "chatZone.running": "运行中…",
  "chatZone.done": "已结束：",
  "chatZone.send": "发送",
  "chatZone.sending": "发送中…",
  "chatZone.taskPlaceholder": "跟角色说点什么…（Ctrl+Enter 发送）",
  "chatZone.waiting": "等待输入…（输出会在这里流式显示）",
  "chatZone.waitingModel": "… 正在等待模型响应",
  "chatZone.tools": "工具",
  "chatZone.toolsEmpty": "（暂无工具调用）",
  "chatZone.logs": "日志",
  "chatZone.noLogs": "没有日志。",
  ...
  "plugins.fetchErrorHint":
    "提示: 这通常意味着后端没有 /api/plugins 接口。在 v0.4.9+ 插件系统由 Rust 进程直接处理，不再需要 sidecar。如果 v0.4.9+ 仍出现此错误，请上报 bug。",
